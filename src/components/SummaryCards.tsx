...
export function SummaryCards({ summary }: SummaryCardsProps) {
  return (
    <section className="summary-grid">
      <CardRoot>
        <CardContent>
          ...
          <strong className="summary-value">
            {duration(summary.useDurationSeconds)}
          </strong>
        </CardContent>
      </CardRoot>
      <CardRoot>
        ...
        <CardContent>
          ...
          <strong className="summary-value">
            {summary.pressureRange
              ? `${summary.pressureRange.min} - ${summary.pressureRange.max}`
              : "-"}
          </strong>
        </CardContent>
      </CardRoot>
      ...
      <CardRoot>
        <CardContent>
          <span className="summary-label">波形采样</span>
          <strong className="summary-value">
            {Object.values(summary.sampleCounts)
